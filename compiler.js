...
(function() {
  var CoffeeScript, Compiler, Element, Scope, compile, nodes, parse, prepare, quote, render,
    __slice = [].slice;
  ...
  Compiler = (function() {
    ...
    Compiler.prototype.expand = function(child) {
      ...
      return this.elem(child.tag, child.attrs, child.children);
    };

    Compiler.prototype.main = function(result) {
      return this.scope.expressions = this.block([new nodes.Return(result)]);
    };
  ...
  exports.parse = parse = function(src, opts) {
    ...
    pp = (function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push(new Element('p', {}, pieces));
      }
      return _results;
    })();
